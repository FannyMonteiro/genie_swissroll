...
!!$         & genie_sfxatm1      & ! input/output
!!$         & )
!!$  end subroutine rokgem_glt_wrapper
...
! ******************************************************************************************************************************** !
  ...
  subroutine biogem_tracercoupling_wrapper
    implicit none
    call biogem_tracercoupling_tmp(                              &
         & go_ts,                                            & ! input/output
         & go_ts1                                            & ! input/output
         )
...
print*,'> START goldlite_wrapper'
    call goldlite(                                                            &
         & go_ts(intrac_ocn-5:intrac_ocn,1:ilon1_ocn,1:ilat1_ocn,1:inl1_ocn), & ! input/output
         & go_ts1(intrac_ocn-5:intrac_ocn,1:ilon1_ocn,1:ilat1_ocn,1:inl1_ocn) & ! input/output
         )
