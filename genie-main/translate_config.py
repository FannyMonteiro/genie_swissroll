...
def translate_config(config_filename,script_name='translate_config.py'):
    ...
    prefixes = {'genie' : 'ma', 'embm' : 'ea', 'igcm' : 'ia', 'fixedatmos' : 'fa', 'fakeatmos' : 'fk', 'goldstein' : 'go', 'slabocean' : 'so', 'fixedocean' : 'fo', 'goldsteinseaice' : 'gs', 'slabseaice' : 'ss', 'fixedseaice' : 'fs', 'fixedicesheet' : 'fi', 'fixedchem' : 'fc', 'ichem' : 'ic', 'mosestriffid' : 'ml', 'ents' : 'ents', 'GEM' : 'gm', 'biogem' : 'bg', 'atchem' : 'ac', 'sedgem' : 'sg', 'rokgem' : 'rg', 'ecogem' : 'eg', 'gemlite' : 'gl', 'goldlite' : 'll', 'ocnlite' : 'ol', 'wind' : 'wi'}
