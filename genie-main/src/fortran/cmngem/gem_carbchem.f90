...
CONTAINS
       ...
       IF ((loc_H1 < const_real_nullsmall) .OR. (loc_H2 < const_real_nullsmall)) THEN
          if (.NOT. error_carbchem) then
             CALL sub_report_error(                                                         &
                  ...
                  & 'CARBONATE CHEMISTRY HAS NOT BEEN UPDATED :(',                          &
  ...
  subroutine sub_calc_carb_r13C(dum_T,dum_DIC,dum_DIC_13C,dum_carb,dum_carbisor)
    ...
    loc_DIC_d13C = fun_calc_isotope_delta(dum_DIC,dum_DIC_13C,const_standards(11),.FALSE.)
    ...
    loc_DIC_r13C  = &
         ...
         dum_DIC
    loc_DIC_d13C = fun_calc_isotope_delta(dum_DIC,loc_DIC_r13C*dum_DIC,const_standards(11),.FALSE.)
  ...
  subroutine sub_calc_carb_r14C(dum_T,dum_DIC,dum_DIC_14C,dum_carb,dum_carbisor)
    ...
    ! initialize local variables
    loc_TC = dum_T - const_zeroC
    loc_DIC_d14C = fun_calc_isotope_delta(dum_DIC,dum_DIC_14C,const_standards(12),.FALSE.)
    ! calculate local fractionation factors
    ! epsilon_bg = epsilon(HCO3- - CO2(G))
    ! epsilon_dg = epsilon(CO2 - CO2(g))
    ! epsilon_cg = epsilon(CO32- - CO2(g))
    ...
    loc_DIC_r14C  = &
         ...
         dum_DIC
    loc_DIC_d14C = fun_calc_isotope_delta(dum_DIC,loc_DIC_r14C*dum_DIC,const_standards(12),.FALSE.)
    ! write to results variable
