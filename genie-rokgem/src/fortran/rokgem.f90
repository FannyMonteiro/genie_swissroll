...
! dum_respveg(n_i,n_j) - vegetation respiration array from land veg module (ENTS). NOTE - run_off, photo and respveg only work for same grid as RokGeM at the moment
!
! Output:
!
...
!        Conditionals commented out because no calibration is done for stage 1 spin-up and files are needed to be written for stage 2.
