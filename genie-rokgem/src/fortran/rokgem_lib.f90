...
MODULE rokgem_lib
  ...
  REAL:: par_k_Ca                                                                        ! constant for temperature-carbonate weathering feedback
  ...
  NAMELIST /ini_rokgem_nml/par_k_Ca,par_E_a,par_k_run,par_beta
  ...
  NAMELIST /ini_rokgem_nml/par_weather_CaSiO3,par_weather_CaSiO3_fracC,par_weather_CaSiO3_fracC_d13C,par_weather_CaSiO3_fracP
