...
MODULE biogem_lib
  ...
  integer::par_t_sig_count                                       ! integration count for snap-shot (time-series) solar forcing data
  NAMELIST /ini_biogem_nml/par_t_sig_count
  ...
  INTEGER,PARAMETER::n_data_max                           = 8191 ! (maximum) number of (time series) data points (2^13 - 1)
  ...
  INTEGER,PARAMETER::n_diag_bio                           = 11   ! Updated from 9 to add NH4 and NO3 contribution to new production - Fanny (Sep 2015) 
  ...
  INTEGER,PARAMETER::idiag_bio_NH4assim_new              = 10    ! contribution of NH4 to new production - Fanny (June 2015)
  INTEGER,PARAMETER::idiag_bio_NO3assim_new              = 11    ! contribution of NO3 to new production - Fanny (June 2015)
  ...
  CHARACTER(len=14),DIMENSION(n_diag_bio),PARAMETER::string_diag_bio = (/ &
       ...
       & 'k_nutrients   ', &
       & 'DOMfrac       ', &
       & 'NH4assim_new  ', &      !Fanny (June 2015)
       & 'NO3assim_new  ' /)      !Fanny (Sep 2015)
